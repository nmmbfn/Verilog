...
HD_PWD='C:/Verilog_lab/MY_fadder/MY_fadder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log f_hadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source f_hadder.tcl -notrace
