...
HD_PWD='C:/Verilog_lab/MY_fadder/MY_fadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f_hadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f_hadder.tcl
