...
HD_PWD='C:/Verilog_lab/my_hadder/my_hadder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_hadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_hadder.tcl -notrace
