...
HD_PWD='C:/Verilog_lab/my_hadder/my_hadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_hadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_hadder.tcl
